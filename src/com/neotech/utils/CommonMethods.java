...
public class CommonMethods extends BaseClass {
	...
	/**
	 * This method will send a text to the alert. If no alert is present then it will catch the exception.
	 * 
	 * @param text
	 */
	...
	/**
	 * This method will method will switch to a frame using name or id. It will also handle the NoSuchFrameException.
	 * 
	 * @param nameOrId
	 */
	...
	/**
	 * This method will switch to a frame using a web element. It will also handle the NoSuchFrameException.
	 * 
	 * @param element
	 */
